...
fn fruit_basket(basket: &mut HashMap<Fruit, u32>) {
    ...
    for fruit in fruit_kinds {
        ...
        // present!
        // if fruit not in fruit_basket?{ // CLOSE
        basket.entry(fruit).or_insert(100); // if in basket, don't do nothing, if there is, add 100 to the value part with fruit name
        // *basket.entry(fruit).or_insert(1) += 1;
        // Apple --> basket --> Apple:1
        // Apple:2
